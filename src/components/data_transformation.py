...
class DataTransformation:
    ...
    def get_data_transformer_object(self):      # To create all the pickle files
        
        '''This function is responsible for data transformation with respect to different kind of data'''
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_obj(                # to save the pickle file
